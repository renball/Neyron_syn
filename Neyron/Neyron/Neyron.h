...
public:
    ...
    double HodgkinHuxley(int i, double f[Nn], double I, int n_ind, double V_1)
    {
        switch (i)
        {
        case 0:
    ...
    void RungeKutta(double dt, double f[Nn], double f_next[Nn], double I, int n_ind, double V_1)
    {
        double k[Nn][4];
    ...
    double HodgkinHuxley_default(int i, double f[Nn], double I)
    {
        switch (i)
        {
        case 0:
    ...
    void RungeKutta_default(double dt, double f[Nn], double f_next[Nn], double I)
    {
        double k[Nn][4];
